      ...
      <section>
        ...
        <div class="contentBx">
          <div className="LoginBtn">
            <ButtonC type="button" id="login" placeholder="Log In"></ButtonC>
          </div>
          <div className="inputsF">
            <h1>Registro Proveedor</h1>
            <InputC type="text" id="name" placeholder="Nombre" />
            <InputC type="text" id="apellido" placeholder="Apellido" />
            <InputC type="email" id="email" placeholder="Dirección de E-mail" />
            <InputC type="text" id="servicio" placeholder="Servicio a Ofrecer" />
            <InputC type="password" id="contrasena" placeholder="Contraseña" />
            <ButtonC type="button" id="signup" placeholder="Sign Up" />
            <h3>Soy Cliente</h3>
          </div>
        </div>
      </section>
